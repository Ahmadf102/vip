...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Tomket Script Installer ${YELLOW}(${NC}${green} V 2.0 ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Auther : ${green}FAHRIZAL ${NC}${YELLOW}(${NC} ${green}TOMKET VPN${NC}${YELLOW})${NC}"
echo -e "       © Recode By TOMKET VPN ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
###### IZIN SC 
...
IZIN=$(curl -sS https://raw.githubusercontent.com/Ahmadf102/izin/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
clear
    ...
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6285879296673"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
# USERNAME
rm -f /usr/bin/user
#username=$(curl https://raw.githubusercontent.com/Ahmadf102/vip//main/izin | grep $MYIP | awk '{print $2}')
#echo "$username" >/usr/bin/user
#expx=$(curl https://raw.githubusercontent.com/Ahmadf102/vip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
#Exp1=$(curl https://raw.githubusercontent.com/Ahmadf102/vip/main/izin | grep $MYIP | awk '{print $4}')
#if [[ $today < $Exp1 ]]; then
#sts="${Info}"
#else
#sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ahmadf102/izin/main/ip"
